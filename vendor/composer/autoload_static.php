...
class ComposerStaticInit0fff5a54f9c45cc690600d3b83441303
{
    ...
    public static $classMap = array (
        ...
        'SAHCFWC\\Bootstrap\\App' => __DIR__ . '/../..' . '/includes/bootstrap/class-app.php',
        'SAHCFWC\\Classes\\Checkout_Button_Url_Ajax' => __DIR__ . '/../..' . '/includes/classes/class-checkout-button-url-ajax.php',
        'SAHCFWC\\Classes\\Meta_Table_Session' => __DIR__ . '/../..' . '/includes/classes/class-meta-table-session.php',
        'SAHCFWC\\Classes\\Payment_Gateway' => __DIR__ . '/../..' . '/includes/classes/class-payment-gateway.php',
        'SAHCFWC\\Classes\\Post_Checkout' => __DIR__ . '/../..' . '/includes/classes/class-post-checkout.php',
        'SAHCFWC\\Classes\\Pre_Checkout' => __DIR__ . '/../..' . '/includes/classes/class-pre-checkout.php',
        ...
        'SAHCFWC\\Pages\\Dashboard' => __DIR__ . '/../..' . '/includes/pages/class-dashboard.php',
        'SAHCFWC\\RestApi\\License_Manager' => __DIR__ . '/../..' . '/includes/rest-api/class-license-manager.php',
        'SAHCFWC\\RestApi\\Stripe_Country_And_Key_Status' => __DIR__ . '/../..' . '/includes/rest-api/class-stripe-country-and-key-status.php',
        'SAHCFWC\\RestApi\\Stripe_Local_Payment_Methods' => __DIR__ . '/../..' . '/includes/rest-api/class-stripe-local-payment-methods.php',
        'SAHCFWC\\RestApi\\Stripe_Session_Api' => __DIR__ . '/../..' . '/includes/rest-api/class-stripe-session-api.php',
        'SAHCFWC\\Settings\\Stripe_Checkout' => __DIR__ . '/../..' . '/includes/settings/class-stripe-checkout.php',
        'SAHCFWC\\Traits\\Helpers' => __DIR__ . '/../..' . '/includes/traits/helpers.php',
        'SAHCFWC\\Traits\\RestAPI' => __DIR__ . '/../..' . '/includes/traits/rest-api.php',
        'SAHCFWC\\Traits\\Singleton' => __DIR__ . '/../..' . '/includes/traits/singleton.php',
        'SAHCFWC\\Traits\\Stripe_Local_Payment_Methods' => __DIR__ . '/../..' . '/includes/traits/stripe-local-payment-methods-data.php',
        'SAHCFWC\\Webhooks\\Stripe_Lister' => __DIR__ . '/../..' . '/includes/webhooks/class-stripe-lister.php',
