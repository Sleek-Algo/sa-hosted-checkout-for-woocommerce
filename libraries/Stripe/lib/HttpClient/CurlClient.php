...
use SAHCFWC\Libraries\Stripe\Exception;
use SAHCFWC\Libraries\Stripe\Stripe;
use SAHCFWC\Libraries\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \SAHCFWC\Libraries\Stripe\Util\RandomGenerator */
     ...
     * @param null|\SAHCFWC\Libraries\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\SAHCFWC\Libraries\Stripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
    ...
    private function handleCurlError($url, $errno, $message, $numRetries)
    {
        switch ($errno) {
            ...
            case \CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to SAHCFWC\Libraries\Stripe ({$url}).  Please check your "
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\SAHCFWC\Libraries\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
    ...
    private function canSafelyUseHttp2()
    {
        ...
        // (cf. https://github.com/curl/curl/issues/2416), which SAHCFWC\Libraries\Stripe use.
