...
/**
 * A <code>Transfer</code> object is created when you move funds between SAHCFWC\Libraries\Stripe accounts as
 * part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a
 * SAHCFWC\Libraries\Stripe account to a card or bank account. This behavior has since been split
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\Account $destination ID of the SAHCFWC\Libraries\Stripe account the transfer was sent to.
 * @property null|string|\SAHCFWC\Libraries\Stripe\Charge $destination_payment If the destination is a SAHCFWC\Libraries\Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\Charge $source_transaction ID of the charge that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
    ...
    /**
     * To send funds from your SAHCFWC\Libraries\Stripe account to a connected account, you create a new
     * transfer object. Your <a href="#balance">SAHCFWC\Libraries\Stripe balance</a> must be able to
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Transfer the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Transfer> of ApiResources
     */
     ...
     * from either a transfer creation request or the transfer list, and SAHCFWC\Libraries\Stripe will
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Transfer
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Transfer the updated resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\TransferReversal> the list of transfer reversals
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\TransferReversal
     */
