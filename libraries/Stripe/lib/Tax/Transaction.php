...
namespace SAHCFWC\Libraries\Stripe\Tax;
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $customer_details
 * @property null|\SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Tax\TransactionLineItem> $line_items The tax collected or refunded, by line item.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $reversal If <code>type=reversal</code>, contains information about what was reversed.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $ship_from_details The details of the ship from location, such as the address.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $shipping_cost The shipping cost details for the transaction.
...
class Transaction extends \SAHCFWC\Libraries\Stripe\ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Tax\Transaction
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Tax\Transaction the created transaction
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Tax\TransactionLineItem> list of transaction line items
     */
