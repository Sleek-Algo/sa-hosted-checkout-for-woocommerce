...
/**
 * You can use Tax <code>Settings</code> to manage configurations used by SAHCFWC\Libraries\Stripe Tax calculations.
 *
 * Related guide: <a href="https://stripe.com/docs/tax/settings-api">Using the Settings API</a>
 *
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $defaults
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $head_office The place where your business is located.
 ...
 */
class Settings extends \SAHCFWC\Libraries\Stripe\SingletonApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Tax\Settings
     */
