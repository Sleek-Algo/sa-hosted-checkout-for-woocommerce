...
namespace SAHCFWC\Libraries\Stripe\Climate;
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $beneficiary
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 * @property string|\SAHCFWC\Libraries\Stripe\Climate\Product $product Unique ID for the Climate <code>Product</code> this order is purchasing.
 ...
 */
class Order extends \SAHCFWC\Libraries\Stripe\ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Climate\Order the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Climate\Order> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Climate\Order the updated resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Climate\Order the canceled order
     */
