 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $delivery_estimate The estimated range for how long shipping will take, meant to be displayable to the customer. This will appear on CheckoutSessions.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $fixed_amount
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\TaxCode $tax_code A <a href="https://stripe.com/docs/tax/tax-categories">tax code</a> ID. The Shipping tax code is <code>txcd_92010001</code>.
...
class ShippingRate extends ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\ShippingRate the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\ShippingRate> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\ShippingRate the updated resource
     */
