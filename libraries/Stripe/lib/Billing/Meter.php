 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $customer_mapping
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $default_aggregation
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $value_settings
 */
class Meter extends \SAHCFWC\Libraries\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';

    use \SAHCFWC\Libraries\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Billing\Meter the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Billing\Meter> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Billing\Meter the updated resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Billing\Meter the deactivated meter
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Billing\Meter the reactivated meter
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Billing\MeterEventSummary> the list of meter event summaries
     */
