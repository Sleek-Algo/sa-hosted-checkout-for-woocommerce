...
/**
 * This is an object representing a person associated with a SAHCFWC\Libraries\Stripe account.
 *
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $additional_tos_acceptances
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $address
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $dob
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for this person</a>, including what information needs to be collected, and by when.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $registered_address
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $relationship
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $verification
 */
class Person extends ApiResource
{
    ...
    /**
     * @return string the API URL for this SAHCFWC\Libraries\Stripe account reversal
     */
     ...
     *
     * @throws \SAHCFWC\Libraries\Stripe\Exception\BadMethodCallException
     */
