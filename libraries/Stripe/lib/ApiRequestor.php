...
class ApiRequestor
{
     ...
     * @static
     *
     * @param string     $apiKey the SAHCFWC\Libraries\Stripe API key, to be used in regular API requests
     * @param null       $clientInfo client user agent information
     * @param null       $appInfo information to identify a plugin that integrates SAHCFWC\Libraries\Stripe using this library
     * @param 'v1'|'v2' $apiMode
     *
     * @return array
     */
    ...
    private function _prepareRequest($method, $url, $params, $headers, $apiMode)
    {
        ...
        if (!$myApiKey) {
            $msg = 'No API key provided.  (HINT: set your API key using '
                ...
                . 'the SAHCFWC\Libraries\Stripe web interface.  See https://stripe.com/api for '
