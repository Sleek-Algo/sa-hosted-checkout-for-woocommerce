 ...
 * @property \SAHCFWC\Libraries\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your SAHCFWC\Libraries\Stripe account as a result of this dispute.
 * @property string|\SAHCFWC\Libraries\Stripe\Charge $charge ID of the charge that's disputed.
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $evidence
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $evidence_details
 * @property bool $is_charge_refundable If true, it's still possible to refund the disputed payment. After the payment has been fully refunded, no further funds are withdrawn from your SAHCFWC\Libraries\Stripe account as a result of this dispute.
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $payment_method_details
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Dispute> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Dispute
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Dispute the updated resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Dispute the closed dispute
     */
