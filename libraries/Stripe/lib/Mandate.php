 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $customer_acceptance
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $multi_use
 * @property null|string $on_behalf_of The account (if any) that the mandate is intended for.
 * @property string|\SAHCFWC\Libraries\Stripe\PaymentMethod $payment_method ID of the payment method associated with this mandate.
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $payment_method_details
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $single_use
...
class Mandate extends ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Mandate
     */
