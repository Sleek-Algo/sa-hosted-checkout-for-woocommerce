...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function &__get($k)
    {
        ...
        if (!empty($this->_transientValues) && $this->_transientValues->includes($k)) {
            ...
            $message = "SAHCFWC\Libraries\Stripe Notice: Undefined property of {$class} instance: {$k}. "
        ...
        $class = static::class;
        Stripe::getLogger()->error("SAHCFWC\Libraries\Stripe Notice: Undefined property of {$class} instance: {$k}");
     ...
     * SAHCFWC\Libraries\Stripe object.
     *
    ...
    /**
     * Returns a pretty JSON representation of the SAHCFWC\Libraries\Stripe object.
     *
     * @return string the JSON representation of the SAHCFWC\Libraries\Stripe object
     */
    ...
    /**
     * @return null|ApiResponse The last response from the SAHCFWC\Libraries\Stripe API
     */
    ...
    /**
     * Sets the last response from the SAHCFWC\Libraries\Stripe API.
     *
