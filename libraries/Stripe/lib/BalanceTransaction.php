...
/**
 * Balance transactions represent funds moving through your SAHCFWC\Libraries\Stripe account.
 * SAHCFWC\Libraries\Stripe creates them for every type of transaction that enters or leaves your SAHCFWC\Libraries\Stripe account balance.
 *
 ...
 * @property int $available_on The date that the transaction's net funds become available in the SAHCFWC\Libraries\Stripe balance.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|float $exchange_rate If applicable, this transaction uses an exchange rate. If money converts from currency A to currency B, then the <code>amount</code> in currency A, multipled by the <code>exchange_rate</code>, equals the <code>amount</code> in currency B. For example, if you charge a customer 10.00 EUR, the PaymentIntent's <code>amount</code> is <code>1000</code> and <code>currency</code> is <code>eur</code>. If this converts to 12.34 USD in your SAHCFWC\Libraries\Stripe account, the BalanceTransaction's <code>amount</code> is <code>1234</code>, its <code>currency</code> is <code>usd</code>, and the <code>exchange_rate</code> is <code>1.234</code>.
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject[] $fee_details Detailed breakdown of fees (in cents (or local equivalent)) paid for this transaction.
 * @property int $net Net impact to a SAHCFWC\Libraries\Stripe balance (in cents (or local equivalent)). A positive value represents incrementing a SAHCFWC\Libraries\Stripe balance, and a negative value decrementing a SAHCFWC\Libraries\Stripe balance. You can calculate the net impact of a transaction on a balance by <code>amount</code> - <code>fee</code>
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\ApplicationFee|\SAHCFWC\Libraries\Stripe\ApplicationFeeRefund|\SAHCFWC\Libraries\Stripe\Charge|\SAHCFWC\Libraries\Stripe\ConnectCollectionTransfer|\SAHCFWC\Libraries\Stripe\CustomerCashBalanceTransaction|\SAHCFWC\Libraries\Stripe\Dispute|\SAHCFWC\Libraries\Stripe\Issuing\Authorization|\SAHCFWC\Libraries\Stripe\Issuing\Dispute|\SAHCFWC\Libraries\Stripe\Issuing\Transaction|\SAHCFWC\Libraries\Stripe\Payout|\SAHCFWC\Libraries\Stripe\Refund|\SAHCFWC\Libraries\Stripe\ReserveTransaction|\SAHCFWC\Libraries\Stripe\TaxDeductedAtSource|\SAHCFWC\Libraries\Stripe\Topup|\SAHCFWC\Libraries\Stripe\Transfer|\SAHCFWC\Libraries\Stripe\TransferReversal $source This transaction relates to the SAHCFWC\Libraries\Stripe object.
 * @property string $status The transaction's net funds status in the SAHCFWC\Libraries\Stripe balance, which are either <code>available</code> or <code>pending</code>.
...
class BalanceTransaction extends ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\BalanceTransaction> of ApiResources
     */
