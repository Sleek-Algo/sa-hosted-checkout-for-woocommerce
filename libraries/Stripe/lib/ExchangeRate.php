...
/**
 * <code>ExchangeRate</code> objects allow you to determine the rates that SAHCFWC\Libraries\Stripe is currently
 ...
 * - <em>reconcile SAHCFWC\Libraries\Stripe transactions</em>
 * - <em>determine how much money to send to a connected account</em>
 * - <em>determine app fees to charge a connected account</em>
 *
 * <em>Using this Exchange Rates API beta for any purpose other than to transact on SAHCFWC\Libraries\Stripe is strictly prohibited and constitutes a violation of Stripe's terms of service.</em>
 *
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $rates Hash where the keys are supported currencies and the values are the exchange rate at which the base id currency converts to the key currency.
 */
class ExchangeRate extends ApiResource
{
     ...
     * converted to one another. Only shows the currencies for which SAHCFWC\Libraries\Stripe supports.
     *
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\ExchangeRate> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\ExchangeRate
     */
