...
/**
 * SAHCFWC\Libraries\Stripe Treasury provides users with a container for money called a FinancialAccount that is separate from their Payments balance.
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $balance Balance information for the FinancialAccount
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\Treasury\FinancialAccountFeatures $features Encodes whether a FinancialAccount has access to a particular Feature, with a <code>status</code> enum and associated <code>status_details</code>. SAHCFWC\Libraries\Stripe or the platform can control Features via the requested field.
 * @property \SAHCFWC\Libraries\Stripe\StripeObject[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $status_details
 ...
 */
class FinancialAccount extends \SAHCFWC\Libraries\Stripe\ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Treasury\FinancialAccount the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Treasury\FinancialAccount> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Treasury\FinancialAccount the updated resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Treasury\FinancialAccountFeatures the retrieved financial account features
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Treasury\FinancialAccountFeatures the updated financial account features
     */
