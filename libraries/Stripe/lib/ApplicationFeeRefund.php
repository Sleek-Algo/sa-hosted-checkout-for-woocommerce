 ...
 * the SAHCFWC\Libraries\Stripe account from which the fee was originally collected.
 *
 ...
 * @property string|\SAHCFWC\Libraries\Stripe\ApplicationFee $fee ID of the application fee that was refunded.
...
class ApplicationFeeRefund extends ApiResource
{
    ...
    /**
     * @return string the API URL for this SAHCFWC\Libraries\Stripe refund
     */
