 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\Issuing\PersonalizationDesign $personalization_design The personalization design object belonging to this card.
 * @property null|string|\SAHCFWC\Libraries\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\SAHCFWC\Libraries\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $spending_controls
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \SAHCFWC\Libraries\Stripe\ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Issuing\Card the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Issuing\Card> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Issuing\Card the updated resource
     */
