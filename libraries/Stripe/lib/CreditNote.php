 ...
 * @property string|\SAHCFWC\Libraries\Stripe\Customer $customer ID of the customer.
 * @property null|string|\SAHCFWC\Libraries\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 ...
 * @property string|\SAHCFWC\Libraries\Stripe\Invoice $invoice ID of the invoice.
 * @property \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject[] $pretax_credit_amounts The pretax credit amounts (ex: discount, credit grants, etc) for all line items.
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\Refund $refund Refund related to this credit note.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $shipping_cost The details of the cost of shipping, including the ShippingRate applied to the invoice.
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     * <li>Outside of SAHCFWC\Libraries\Stripe credit: record the amount that is or will be credited
     * outside of SAHCFWC\Libraries\Stripe (using <code>out_of_band_amount</code>).</li> </ul>
     *
     * For post-payment credit notes the sum of the refund, credit and outside of
     * SAHCFWC\Libraries\Stripe amounts must equal the credit note total.
     *
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\CreditNote the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\CreditNote> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\CreditNote
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\CreditNote the updated resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\CreditNoteLineItem> list of credit note line items
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\CreditNote the voided credit note
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\CreditNoteLineItem> the list of credit note line items
     */
