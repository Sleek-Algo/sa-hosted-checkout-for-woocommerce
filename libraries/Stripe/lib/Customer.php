 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $address The customer's address.
 * @property null|int $balance The current balance, if any, that's stored on the customer. If negative, the customer has credit to apply to their next invoice. If positive, the customer has an amount owed that's added to their next invoice. The balance only considers amounts that SAHCFWC\Libraries\Stripe hasn't successfully applied to any invoice. It doesn't reflect unpaid invoices. This balance is only taken into account after invoices finalize.
 * @property null|\SAHCFWC\Libraries\Stripe\CashBalance $cash_balance The current funds being held by SAHCFWC\Libraries\Stripe on behalf of the customer. You can apply these funds towards payment intents when the source is &quot;cash_balance&quot;. The <code>settings[reconciliation_mode]</code> field describes if these funds apply to these payment intents manually or automatically.
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\Account|\SAHCFWC\Libraries\Stripe\BankAccount|\SAHCFWC\Libraries\Stripe\Card|\SAHCFWC\Libraries\Stripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you use payment methods created through the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\Discount $discount Describes the current discount active on the customer, if there is one.
 * @property null|string $email The customer's email address.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $invoice_credit_balance The current multi-currency balances, if any, that's stored on the customer. If positive in a currency, the customer has a credit to apply to their next invoice denominated in that currency. If negative, the customer has an amount owed that's added to their next invoice denominated in that currency. These balances don't apply to unpaid invoices. They solely track amounts that SAHCFWC\Libraries\Stripe hasn't successfully applied to any invoice. SAHCFWC\Libraries\Stripe only applies a balance in a specific currency to an invoice after that invoice (which is in the same currency) finalizes.
 * @property null|string $invoice_prefix The prefix for the customer used to generate unique invoice numbers.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $invoice_settings
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property null|\SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Account|\SAHCFWC\Libraries\Stripe\BankAccount|\SAHCFWC\Libraries\Stripe\Card|\SAHCFWC\Libraries\Stripe\Source> $sources The customer's payment sources, if any.
 * @property null|\SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $tax
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\SAHCFWC\Libraries\Stripe\TestHelpers\TestClock $test_clock ID of the test clock that this customer belongs to.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Customer the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Customer the deleted resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Customer> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Customer
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Customer the updated resource
     */
     ...
     * @param null|array|string $opts
     *
     * @return \SAHCFWC\Libraries\Stripe\Customer the updated customer
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\PaymentMethod> list of payment methods
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\PaymentMethod the retrieved payment method
     */
    public function retrievePaymentMethod($payment_method, $params = null, $opts = null)
    {
        ...
        $obj = \SAHCFWC\Libraries\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\SearchResult<\SAHCFWC\Libraries\Stripe\Customer> the customer search results
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\CustomerCashBalanceTransaction> the list of customer cash balance transactions
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\CustomerCashBalanceTransaction
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\BankAccount|\SAHCFWC\Libraries\Stripe\Card|\SAHCFWC\Libraries\Stripe\Source> the list of payment sources (BankAccount, Card or Source)
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\BankAccount|\SAHCFWC\Libraries\Stripe\Card|\SAHCFWC\Libraries\Stripe\Source
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\CashBalance
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\TaxId> the list of tax ids
     */
