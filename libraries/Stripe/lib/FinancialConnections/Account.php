 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \SAHCFWC\Libraries\Stripe\ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\FinancialConnections\Account> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\FinancialConnections\Account
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\FinancialConnections\AccountOwner> list of account owners
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\FinancialConnections\Account the refreshed account
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\FinancialConnections\Account the subscribed account
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\FinancialConnections\Account the unsubscribed account
     */
