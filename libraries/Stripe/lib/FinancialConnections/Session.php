 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $account_holder The account holder for whom accounts are collected in this session.
 * @property \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\FinancialConnections\Account> $accounts The accounts that were collected as part of this Session.
 * @property string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $filters
...
class Session extends \SAHCFWC\Libraries\Stripe\ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\FinancialConnections\Session the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\FinancialConnections\Session
     */
