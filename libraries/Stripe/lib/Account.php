...
/**
 * This is an object representing a SAHCFWC\Libraries\Stripe account. You can retrieve it to see
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $business_profile Business information about the account.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $capabilities
 * @property null|bool $charges_enabled Whether the account can process charges.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $company
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $controller
 ...
 * @property null|string $default_currency Three-letter ISO currency code representing the default currency for the account. This must be a currency that <a href="https://stripe.com/docs/payouts">SAHCFWC\Libraries\Stripe supports in the account's country</a>.
 * @property null|bool $details_submitted Whether account details have been submitted. Accounts with SAHCFWC\Libraries\Stripe Dashboard access, which includes Standard accounts, cannot receive payouts before this is true. Accounts where this is false should be directed to <a href="/connect/onboarding">an onboarding flow</a> to finish submitting account details.
 * @property null|string $email An email address associated with the account. It's not used for authentication and SAHCFWC\Libraries\Stripe doesn't market to this field without explicit approval from the platform.
 * @property null|\SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\BankAccount|\SAHCFWC\Libraries\Stripe\Card> $external_accounts External accounts (bank accounts and debit cards) currently attached to this account. External accounts are only returned for requests where <code>controller[is_controller]</code> is true.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $future_requirements
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $groups The groups associated with the account.
 * @property null|\SAHCFWC\Libraries\Stripe\Person $individual <p>This is an object representing a person associated with a SAHCFWC\Libraries\Stripe account.</p><p>A platform cannot access a person for an account where <a href="/api/accounts/object#account_object-controller-requirement_collection">account.controller.requirement_collection</a> is <code>stripe</code>, which includes Standard and Express accounts, after creating an Account Link or Account Session to start Connect onboarding.</p><p>See the <a href="/connect/standard-accounts">Standard onboarding</a> or <a href="/connect/express-accounts">Express onboarding</a> documentation for information about prefilling information and account onboarding steps. Learn more about <a href="/connect/handling-api-verification#person-information">handling identity verification with the API</a>.</p>
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $requirements
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $settings Options for customizing how the account functions within Stripe.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $tos_acceptance
 * @property null|string $type The SAHCFWC\Libraries\Stripe account type. Can be <code>standard</code>, <code>express</code>, <code>custom</code>, or <code>none</code>.
 */
class Account extends ApiResource
{
    ...
    /**
     * With <a href="/docs/connect">Connect</a>, you can create SAHCFWC\Libraries\Stripe accounts for
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Account the created resource
     */
     ...
     *
     * Live-mode accounts where SAHCFWC\Libraries\Stripe is responsible for negative account balances
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Account the deleted resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Account> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Account the updated resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Account
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\StripeObject object containing the response from the API
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Account the rejected account
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Capability> the list of capabilities
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Capability
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\BankAccount|\SAHCFWC\Libraries\Stripe\Card> the list of external accounts (BankAccount or Card)
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\BankAccount|\SAHCFWC\Libraries\Stripe\Card
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\LoginLink
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Person> the list of persons
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Person
     */
