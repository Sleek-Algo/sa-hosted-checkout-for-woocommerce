 ...
 */
class SubscriptionItemService extends \SAHCFWC\Libraries\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\SubscriptionItem>
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\UsageRecordSummary>
     */
     ...
     * with a quantity.
     *
     * Usage records provide <code>quantity</code> information that SAHCFWC\Libraries\Stripe uses to
     ...
     * billing</a> plan, SAHCFWC\Libraries\Stripe helps you send accurate invoices to your customers.
     *
     ...
     * there is more than one usage record with the same timestamp, SAHCFWC\Libraries\Stripe adds the
