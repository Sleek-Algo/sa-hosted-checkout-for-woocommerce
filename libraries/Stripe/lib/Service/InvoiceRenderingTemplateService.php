 ...
 */
class InvoiceRenderingTemplateService extends \SAHCFWC\Libraries\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\InvoiceRenderingTemplate>
     */
     ...
     * SAHCFWC\Libraries\Stripe objects (customers, invoices, etc.) can reference it. The template can
     * also no longer be updated. However, if the template is already set on a SAHCFWC\Libraries\Stripe
    ...
    /**
     * Unarchive an invoice rendering template so it can be used on new SAHCFWC\Libraries\Stripe objects
     * again.
     *
     * @param string $id
     * @param null|array $params
