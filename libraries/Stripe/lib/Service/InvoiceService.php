 ...
 */
class InvoiceService extends \SAHCFWC\Libraries\Stripe\Service\AbstractService
{
    /**
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\Invoice>
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\InvoiceLineItem>
     */
    ...
    /**
     * SAHCFWC\Libraries\Stripe automatically finalizes drafts before sending and attempting payment on
    ...
    /**
     * SAHCFWC\Libraries\Stripe automatically creates and then attempts to collect payment on invoices
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\SearchResult<\SAHCFWC\Libraries\Stripe\Invoice>
     */
    ...
    /**
     * SAHCFWC\Libraries\Stripe will automatically send invoices to customers according to your <a
     * href="https://dashboard.stripe.com/account/billing/automatic">subscriptions
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\InvoiceLineItem
     */
     ...
     * href="#create_credit_note">credit note</a> instead. SAHCFWC\Libraries\Stripe recommends that you
