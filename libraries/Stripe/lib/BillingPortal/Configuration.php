...
namespace SAHCFWC\Libraries\Stripe\BillingPortal;
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\Application $application ID of the Connect Application that created the configuration.
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $business_profile
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $features
 ...
 * @property \SAHCFWC\Libraries\Stripe\StripeObject $login_page
...
class Configuration extends \SAHCFWC\Libraries\Stripe\ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\BillingPortal\Configuration the created resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\BillingPortal\Configuration> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\BillingPortal\Configuration
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\BillingPortal\Configuration the updated resource
     */
