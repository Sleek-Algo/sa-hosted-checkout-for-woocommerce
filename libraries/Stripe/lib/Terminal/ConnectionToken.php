...
/**
 * A Connection Token is used by the SAHCFWC\Libraries\Stripe Terminal SDK to connect to a reader.
 *
 ...
 * @property string $secret Your application should pass this token to the SAHCFWC\Libraries\Stripe Terminal SDK.
 */
class ConnectionToken extends \SAHCFWC\Libraries\Stripe\ApiResource
{
    const OBJECT_NAME = 'terminal.connection_token';

    /**
     * To connect to a reader the SAHCFWC\Libraries\Stripe Terminal SDK needs to retrieve a short-lived
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Terminal\ConnectionToken the created resource
     */
