 ...
 * represent a customer's payment instrument, and can be used with the SAHCFWC\Libraries\Stripe API
 * just like a <code>Card</code> object: once chargeable, they can be charged, or can be
 * attached to customers.
 *
 * SAHCFWC\Libraries\Stripe doesn't recommend using the deprecated <a href="https://stripe.com/docs/api/sources">Sources API</a>.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $ach_credit_transfer
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $ach_debit
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $code_verification
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $p24
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $receiver
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $redirect
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $sepa_credit_transfer
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $sepa_debit
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $sofort
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $source_order
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $three_d_secure
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\Source the created resource
     */
     ...
     * creation request and SAHCFWC\Libraries\Stripe will return the corresponding up-to-date source
     * object information.
     *
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Source
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Source the updated resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \SAHCFWC\Libraries\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Source the detached source
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\SourceTransaction> list of source transactions
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Source the verified source
     */
