 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\SAHCFWC\Libraries\Stripe\Customer $customer The ID of the customer that the bank account is associated with.
 ...
 * @property null|\SAHCFWC\Libraries\Stripe\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for the bank account</a>, including what information needs to be collected, and by when.
...
class BankAccount extends ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\BankAccount the deleted resource
     */
