 ...
 * notified about events that happen in your SAHCFWC\Libraries\Stripe account or connected
 * accounts.
 *
...
class WebhookEndpoint extends ApiResource
{
     ...
     *
     * @return \SAHCFWC\Libraries\Stripe\WebhookEndpoint the created resource
     */
     ...
     * management</a> page of the SAHCFWC\Libraries\Stripe dashboard.
     *
     * @param null|array $params
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\WebhookEndpoint the deleted resource
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\Collection<\SAHCFWC\Libraries\Stripe\WebhookEndpoint> of ApiResources
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\WebhookEndpoint
     */
     ...
     * @throws \SAHCFWC\Libraries\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SAHCFWC\Libraries\Stripe\WebhookEndpoint the updated resource
     */
