...
class Stripe
{
    /** @var string The SAHCFWC\Libraries\Stripe API key to be used for requests. */
    public static $apiKey;

    /** @var string The SAHCFWC\Libraries\Stripe client_id to be used for Connect requests. */
    public static $clientId;

    /** @var string The base URL for the SAHCFWC\Libraries\Stripe API. */
    public static $apiBase = 'https://api.stripe.com';

    /** @var string The base URL for the OAuth API. */
    public static $connectBase = 'https://connect.stripe.com';

    /** @var string The base URL for the SAHCFWC\Libraries\Stripe API uploads endpoint. */
    public static $apiUploadBase = 'https://files.stripe.com';

    /** @var string The version of the SAHCFWC\Libraries\Stripe API to use for requests. */
    public static $apiVersion = \SAHCFWC\Libraries\Stripe\Util\ApiVersion::CURRENT;
    ...
    /** @var float Maximum delay between retries, in seconds, that will be respected from the SAHCFWC\Libraries\Stripe API */
    ...
    /**
     * @return null|string The SAHCFWC\Libraries\Stripe account ID for connected account
     *   requests
     */
    ...
    /**
     * @param null|string $accountId the SAHCFWC\Libraries\Stripe account ID to set for connected
     *   account requests
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the SAHCFWC\Libraries\Stripe API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to SAHCFWC\Libraries\Stripe as an HTTP Header
     * with the current request. This enables SAHCFWC\Libraries\Stripe to do latency and metrics analysis without adding extra
