...
if ( function_exists( 'sahcfwc_fs' ) ) {
    sahcfwc_fs()->set_basename( false, __FILE__ );
} else {
    ...
    if ( !function_exists( 'sahcfwc_fs' ) ) {
        ...
        function sahcfwc_fs() {
            ...
            if ( !isset( $sahcfwc_fs ) ) {
                ...
                $sahcfwc_fs = fs_dynamic_init( array(
                    'id'             => '16167',
                    'slug'           => 'sa-hosted-checkout-for-woocommerce',
                    'type'           => 'plugin',
                    'public_key'     => 'pk_8ff0e011799198848ddafd4a3ea7f',
                    'is_premium'     => false,
                    'premium_suffix' => 'Premium',
                    'has_addons'     => false,
                    'has_paid_plans' => true,
                    'menu'           => array(
                        'slug'       => 'sahcfwc-dashboard',
                        'first-path' => 'admin.php?page=sahcfwc-dashboard&welcome-message=true',
                        'support'    => false,
                        'parent'     => array(
                            'slug' => 'woocommerce',
                        ),
